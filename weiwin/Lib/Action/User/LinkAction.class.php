...

{
...

    {
		...
		array('module' => 'Shop', 'linkcode' => ('index.php?g=Wap&m=Product&a=cats&token=' . $this->token) . '&wecha_id={wechat_id}', 'name' => $this->modules['Shop'], 'sub' => 0, 'canselected' => 1, 'linkurl' => '', 'keyword' => '微商城', 'askeyword' => 1), 
