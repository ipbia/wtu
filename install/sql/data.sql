...
INSERT INTO `wy_keyword` (`id`, `keyword`, `pid`, `
-- --------------------------------------------------------
...
INSERT INTO `wy_user_group` (`id`, `name`, `diynum`, `connectnum`, `iscopyright`, `activitynum`, `price`, `statistics_user`, `create_card_num`, `wechat_card_num`, `status`) VALUES
