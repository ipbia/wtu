...
'license'=>'<div class="license"><h1>系统安装协议</h1>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 三一互联微信公共平台，还是部份栏目使用 三一互联微信公共平台。</p>
				<p>4、未经官方许可，禁止在 三一互联微信公共平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：</b> 2014年04月12日</p>
                <p align=right>BY 三一互联微信公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 三一互联微信公共平台V'.SOFT_VERSION.' 安装程序',
...
<meta content="赢微信公共平台" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 三一互联微信公共平台© v1.0 2012-2014</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
