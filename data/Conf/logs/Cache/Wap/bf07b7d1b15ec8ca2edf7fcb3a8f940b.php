...
<link href="<?php echo RES;?>/css/allcss/cate<?php echo ($tpl["tpltypeid"]); ?>_<?php echo ($tpl["color_id"]); ?>.css" rel="stylesheet" type="text/css" />
    <!--  <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/121/common.css" media="all"> -->
     
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/66/reset.css" media="all">
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/66/font-awesome.css" media="all">
<!-- <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/121/home-43.css" media="all"> -->
<script type="text/javascript" src="<?php echo RES;?>/css/61/jQuery.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/66/zepto.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/66/swipe.js"></script>
    </head>
                ...
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i < 5): ?><dl>
                    <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                        ...
                        <div>
                            ...
                            <dt style="margin-left:-16px;font-size:9px;"><?php echo ($vo["name"]); ?></dt>
                    </a>
                    </dl><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                    
                </li>
                <li class="box">
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($i > 4) and ($i < 7)): ?><dl>
                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                            <dd>
                                <div>
                                    <span>
                                        <img src="<?php echo ($vo["img"]); ?>" class="icon-smile" style="width:43px;height:23px;">
                                    </span>
                                </div>
                            </dd>
...
<div id="plug-wrap" onclick="closeall()" style=""></div>
