...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 ...
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="site_name" value="<?php echo C('site_name');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：三一互联</span>
	 ...
	 <tr> 
      ...
      <td><input type="text" name="phone" value="<?php echo C('phone');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;填写您的联系电话</span>
...
Banner4:
  ...
  <input type="text" class="ipt" id="banner4" name="banner4" value="<?php echo C('banner4');?>" size="45" />		 	 	 </tr>  
	...
	<tr> 
      ...
      <td><input type="text" name="site_my" value="<?php echo C('site_my');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.fweir.com</span>
	...
	<tr> 
      ...
      <td><input type="text" name="site_qq" value="<?php echo C('site_qq');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:47478439</span>
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="counts" class="ipt" style="width:252px;height:25px;margin:5px 0 5px 0;" /><?php echo C('counts');?></textarea><span>&nbsp;&nbsp;例:18015578821</span>
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:server@www.fweir.com</span>
