			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
				...
				<tr>
					...
					<td colspan="3" class="lt">
						...
						<input type="text" name="name" class="ipt" size="45" value="<?php echo ($info["name"]); ?>" />					</td>
				...
				<tr>
				  ...
				  <td colspan="3" class="lt">
						...
						<input type="text" class="ipt" id="pic" name="img" value="<?php echo ($info["img"]); ?>" />

                        <script src="<?php echo STATICS;?>/upyun.js"></script>

                        <a href="#" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')">上传</a>					  <a href="#" onclick="viewImg('pic')">预览</a>					</td>
				...
				<tr>
					...
					<td colspan="3" class="lt">
						...
						<input type="url" name="url" class="ipt" value="<?php echo ($info["url"]); ?>" size="45"/>					</td>
