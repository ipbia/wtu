...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform1" action="<?php echo U('Site/tenpay');?>" method="post">
    <tr> 
      <td  height="48" align="right"></td>
      <td><strong>财付通接口</strong>
	  </td>
    </tr>
    <tr> 
      <td  height="48" align="right"><strong>财付通商户号</strong></td>
      <td><input type="text" name="partner" value="<?php echo C('partner');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：1900000113</span>
	  </td>
    </tr>
	 <tr> 
      <td  height="48" align="right"><strong>财付通商户名称：</strong></td>
      <td><input type="text" name="tenpay_name" value="<?php echo C('tenpay_name');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;请登陆财付通帐户查看</span>
	  
    </tr>
	 <tr> 
      <td  height="48" align="right"><strong>财付通密钥：</strong></td>
      <td><input type="text" name="key" value="<?php echo C('key');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;请登陆财付通帐户查看</span>
    </tr> 

   <input type="hidden" name="tfiles" value="tenpay.php" />
    <tr> 
      <td height="48" colspan="2">
		  <div id="addkey"></div>
		  <div style="padding-left:100px;">
