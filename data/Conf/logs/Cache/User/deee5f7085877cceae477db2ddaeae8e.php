...
<li class="tabli current" id="tab0"><a href="index.php?g=User&m=Xitie&a=set&token=<?php echo ($token); ?>&id=<?php echo ($uid); ?>">微喜帖设置</a></li>

<li class="tabli" id="tab0"><a href="index.php?g=User&m=Xitie&a=zhufu&token=<?php echo ($xitie["token"]); ?>&id=<?php echo ($xitie["id"]); ?>&type=2">收到的祝福</a></li>

<li class="tabli" id="tab0"><a href="index.php?g=User&m=Xitie&a=fuyan&token=<?php echo ($xitie["token"]); ?>&id=<?php echo ($xitie["id"]); ?>&type=1">收到的赴宴信息</a></li>
...
<div class="cLine"></div>
      ...
      <script src="<?php echo STATICS;?>/upload.js"></script>   
    ...
    <div class="msgWrap bgfc">
	  ...
	  <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">	 
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tbody>
             ...
             <tr>
              ...
              <td><input type="input" class="px" id="title" name="title" value="<?php echo ($xitie["title"]); ?>" style="width:420px;"></td>
              ...
              <tr>
                 ...
                 <th>关键词：</th>
              	...
              	<td><input type="input" class="px" id="keyword" value="<?php echo ($xitie["keyword"]); ?>" name="keyword" style="width:420px;"></td>
        ...
        <td><input type="text" name="replypicurl" id="replypicurl" value="<?php echo ($xitie["replypicurl"]); ?>"  class="px require" style="width:400px;" /> <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('replypicurl',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('replypicurl')">预览</a></td> 
             ...
             <tr>
                ...
                <th>顺序数字：</td>
              	...
              	<td><input type="input" class="px" id="taxis" value="<?php echo ($xitie["taxis"]); ?>" name="taxis" style="width:420px;">  由小到大排列</td>
            ...
            <tr>
				...
				<td><input style="width:200px;" class="px" id="name_xl" name="name_xl" value="<?php echo ($xitie["name_xl"]); ?>"/></td>
			...
			<tr>
				...
				<td><input style="width:200px;" class="px" id="name_xn" name="name_xn" value="<?php echo ($xitie["name_xn"]); ?>"/></td>
			...
			<tr>
				...
				<td><input size="80" class="px" name="bg_mp3" value="<?php echo ($xitie["bg_mp3"]); ?>"/><br/>仅支持mp3格式</td>
			...
			<tr>
				...
				<td><input size="80" class="px" name="video" value="<?php echo ($xitie["video"]); ?>"/><br/>推荐优酷视频</td>
				...
				<tr>
					...
					<td><textarea style="width:560px;height:75px" name="hua" id="hua" class="px"><?php echo ($xitie["hua"]); ?></textarea><br/> 最多填写120个字</td>
	...
	<div class="control-group">
		...
		<td><div class="controls"> 
			...
			<div class="input-prepend">
				...
				<input type="input" class="px" onClick="WdatePicker()"  value="<?php echo ($xitie["time"]); ?>" name="time"> <span class="maroon">*</span> 
				...
				<tr>
					...
					<td><input type="text" name="address" value="<?php echo ($xitie["address"]); ?>" class="px" style="width:550px;"><br/> 请填写宴会地址</td>
				...
				<tr>
					...
					<td><input type="text" name="tel" value="<?php echo ($xitie["tel"]); ?>" class="px" style="width:550px;"><br/> 请填写宴会电话</td>
       ...
       <th>封面合照：</th> 
        ...
        <td><input type="text" name="pic" id="pic" value="<?php echo ($xitie["pic"]); ?>"  class="px require" style="width:400px;" /> <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td> 
     ...
     <th>照片一：</th>
        ...
        <td><input type="text" name="pic1" id="pic1" value="<?php echo ($xitie["pic1"]); ?>"  class="px require" style="width:400px;" /> <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic1',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a></td> 
...
<th>照片二：</th>
        ...
        <td><input type="text" name="pic2" id="pic2" value="<?php echo ($xitie["pic2"]); ?>"  class="px require" style="width:400px;" /> <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a></td> 
				...
				<tr>
					...
					<td><input type="text" name="copyright" value="<?php echo ($xitie["copyright"]); ?>" class="px" style="width:450px;"><br/> 如：weiwin版权所有</td>
