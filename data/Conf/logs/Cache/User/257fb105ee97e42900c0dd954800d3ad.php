...
<script src="<?php echo STATICS;?>/upyun.js"></script>
  <div class="content" > 
   <div class="cLineB"> 
    <h4>菜品分类设置</h4> 
    <a href="<?php echo U('Dining/cats',array('token'=>$token,'parentid'=>$parentid));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <?php if(is_array($catlist)): $i = 0; $__LIST__ = $catlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat_list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cat_list["id"]); ?>" <?php if(($parentid == $cat_list['id'])): ?>selected<?php endif; ?>><?php echo ($cat_list["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select></td> 
       </tr> 
       <tr> 
        <th>Logo地址：</th>
       ...
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Dining/cats',array('token'=>$token));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
