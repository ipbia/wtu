...
<input type="hidden" id="catUrl" value="<?php echo U('Dining/ajaxCatOptions',array('token'=>$token));?>" />
  <div class="content" > 
   <div class="cLineB"> 
    <h4>菜品设置</h4> 
    <a href="<?php echo U('Dining/index',array('token'=>$token,'dining'=>$isDining));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Dining/index',array('token'=>$token));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
