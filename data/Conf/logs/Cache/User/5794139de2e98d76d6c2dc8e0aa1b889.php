          ...
          <div class="msgWrap">
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              <THEAD>
                <TR>
<TH >编号</TH>
<TH class="keywords">发送方帐号</TH>
<TH class="answer">消息创建时间</TH>
                    <TH  class="category" >信息类型</TH>
                    <TH class="time">消息内容</TH>
<TH class="time">图片链接</TH>
...
<TH class="edit norightborder">操作</TH>
              ...
              <TBODY>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><?php echo ($vo["FromUserName"]); ?></td>
                  <td><?php echo date('Y-m-d h:i:s',$vo['CreateTime']); ?></td>
                  <td><?php echo ($vo["MsgType"]); ?></td>
                  <td><?php echo ($vo["Content"]); ?></td>
                    <td><?php if($vo["PicUrl"] != ''): ?><a href="<?php echo ($vo["PicUrl"]); ?>">查看</a><?php else: ?>无<?php endif; ?></td>
                   <td class="norightborder"> <a href="<?php echo U('Wxusermeasage/more',array('id'=>$vo['id']));?>" title="详情">详情</a> <a href="<?php echo U('Wxusermeasage/answer',array('id'=>$vo['id']));?>">回复</a></td>
