...
<div class="pageNavigator left"> <a href="<?php echo U('Heka/add',array('token'=>$token));?>" title="添加贺卡" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加贺卡</a></div>
