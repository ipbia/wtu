...
<tr>
	...
	<td><div class="cateimg"></div><input class="px"  style="width:250px;"   type="text"   name="picurl" value="<?php echo ($photo["picurl"]); ?>"  id="picurl<?php echo ($i); ?>"/> <a href="###" onclick="window.open('/uploads/upload.php?n=picurl<?php echo ($i); ?>')" class="a_upload">上传</a> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="viewImg('picurl<?php echo ($i); ?>')">预览</a></td>
