...
<a href="<?php echo U($type.'/addcin',array('id'=>$id,'token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加</a>

<a href="<?php echo U($type.'/index',array('token'=>$token));?>" class="right  btnGreen" style="">返回</a> 
