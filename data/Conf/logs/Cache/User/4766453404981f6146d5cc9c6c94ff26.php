...
<li><div class="mleft"><?php echo ($m["name"]); ?></div><div class="mright"><?php if($m['sub']): ?><a href="?g=User&m=Link&a=<?php echo ($m["module"]); ?>&iskeyword=<?php echo intval($_GET['iskeyword']);?>">详细</a><?php endif; if($m['canselected']): ?><a href="###" onclick="returnHomepage('<?php if (!intval($_GET['iskeyword'])){ echo ($m["linkcode"]); }else{ echo ($m["keyword"]); }?>')" style="margin-left:14px;">选中</a><?php endif; ?></div><div style="clear:both"></div></li>
