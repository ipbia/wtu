     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tbody> 
       ...
       <tr> 
        ...
        <td><input type="text" name="logourl" value="<?php echo ($set["logourl"]); ?>" id="pic" class="px" style="width:400px;"  readonly="readonly"/> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td> 
       ...
       <tr> 
        ...
        <TR>
				...
				<script id="editor" name="content" type="text/plain" style="width:590px;height:360px;"><?php echo ($set["content"]); ?></script>
