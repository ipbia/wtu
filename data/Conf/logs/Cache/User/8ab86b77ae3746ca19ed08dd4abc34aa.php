...
<div class="tab">
<ul>
<li class="<?php if(ACTION_NAME == 'index'): ?>current<?php endif; ?> tabli" id="tab0"><a href="<?php echo U('Meirong/index',array('token'=>$token));?>">美容机构简介</a></li>
<li class="<?php if(ACTION_NAME == 'son' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Meirong/son',array('token'=>$token));?>">美容店面</a></li>
<li class="<?php if(ACTION_NAME == 'housetype' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Meirong/housetype',array('token'=>$token));?>">美容服务</a></li>
<li class="<?php if(ACTION_NAME == 'album' or ACTION_NAME == 'album_add'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Meirong/album',array('token'=>$token));?>">美容相册</a></li>
<li class="<?php if(ACTION_NAME == 'expert'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Meirong/expert',array('token'=>$token));?>">客人印象</a></li>
<li class="<?php if(ACTION_NAME == 'meirongindex'): ?>current<?php endif; ?> tabli" id="tab6"><a href="<?php echo U('Reservation/meirongindex',array('token'=>$token));?>">预约管理</a></li>
</ul>
</div>
...
<div class="cLineB">
  ...
  <input type="hidden" name="thetype" value="Meirong">
<?php if($es_data['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($es_data['id']); ?>" /><?php endif; ?>
	...
	<div class="control-group">
		...
		<div class="controls">
      <img class="thumb_img" id="cover_src" src="<?php echo (($es_data['cover'])?($es_data['cover']):'sucai/meirong/1.jpg'); ?>" style="max-height:100px;">
     
  
						
						<input type="text" name="cover" value="<?php echo (($es_data['cover'])?($es_data['cover']):'sucai/meirong/1.jpg'); ?>" id="cover" class="px" style="width:150px;"  readonly="readonly"/><script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('cover',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> 
	...
	<div class="control-group">
         <label class="control-label">美容机构头部图片：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="banner_src" src="<?php echo (($es_data['banner'])?($es_data['banner']):'/sucai/meirong/2.png'); ?>" style="max-height:100px;"> 
                                        
                                            <input type="text" id="banner" name="banner" class="px" value="<?php echo (($es_data['banner'])?($es_data['banner']):'/sucai/meirong/2.png'); ?>"> 
	...
	<div class="control-group">
		<div class="control-group">
                                    <label class="control-label">美容店面头部图片：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'/sucai/meirong/4.png'); ?>" style="max-height:100px;">
                                        <input type="text" name="house_banner" id="house_banner" class="px" value="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'/sucai/meirong/4.png'); ?>">
                                        <span class="help-inline">
                                             <script src="<?php echo STATICS;?>/upyun.js"></script>
...
<div class="control-group">
		<label for="place" class="control-label">美容机构地址：</label>
		<div class="controls"> 
...
<div class="control-group">
     ...
     <div class="control-group">
         <label for="project_brief" class="control-label">美容机构简介：</label>
         <div class="controls">
