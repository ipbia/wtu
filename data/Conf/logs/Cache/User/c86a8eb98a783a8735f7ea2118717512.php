...
<TR>
  ...
  <TH valign="top"><label for="pic">分类图片上传：</label></TH>
   ...
   <TD><input type="input" class="px" id="img" value="<?php echo ($info["img"]); ?>" name="img" id="img" style="width:500px" >  <script src="<?php echo STATICS;?>/upyun.js?2013"></script><a href="###" onclick="chooseFile('img','icon')" class="a_upload">选择</a> <a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img')">预览</a></TD>
...
<TR>
  ...
  <TH valign="top"><label for="keyword">网站图标选择 ：</label></TH>
                                    ...
                                    </div><span class="help-inline">该图标用于二级页面右上角的缩略菜单和部分模板的首页主菜单</span></TD>
...
<TR>
  ...
  <TD><input type="text" name="yanse" id="themeStyle" value="<?php echo ($info["yanse"]); ?>" class="px color" style="width: 55px; background-image: none; background-color:<?php echo ($homeInfo["plugmenucolor"]); ?>; color: rgb(255, 255, 255);" onblur="document.getElementById('plugmenucolor').style.backgroundColor=document.getElementById('themeStyle').value;">可以不选</TD>
