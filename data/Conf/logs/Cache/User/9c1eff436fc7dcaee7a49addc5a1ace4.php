...
<div class="content"  >
<div class="cLineB">
<h4 class="left"><?php echo ($infoType["name"]); ?>回复配置 </h4>
<div class="clr"></div>
</div>
<!--tab start-->
<div class="tab">
<ul>
<li class="current tabli" id="tab2"><a href="<?php echo U('Dining/ComBranches',array('token'=>$token));?>">店铺信息</a></li>
...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Dining/ComIndex',array('token'=>$token,'isBranch'=>1));?>" title="" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/icons/add.png" class="vm">添加</a></div>
<div class="clr"></div>
</div>
...
<td class="norightborder"><a href="<?php echo U('Dining/ComIndex',array('token'=>$token,'id'=>$c['id'],'catid'=>$c['catid']));?>">修改</a> <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Dining/ComDelete',array('token'=>$token,'id'=>$c['id'],'isBranch'=>1));?>');">删除</a></td>
