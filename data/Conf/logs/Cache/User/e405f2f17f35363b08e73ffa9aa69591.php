...
<td><input type="text" name="url" value="<?php echo ($adma["url"]); ?>" class="px" style="width:400px;" id="pic" onblur="document.getElementById('gzhewm').src=document.getElementById('ewm').value;">

<br><script src="tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a><br>
