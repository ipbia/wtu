...
<div class="content"  >
<div class="cLineB">
<h4 class="left">订单管理（<a href="<?php echo U('Dining/orders',array('token'=>$token,'handled'=>0));?>">未处理订单<span style="color:#f00"><?php echo ($unhandledCount); ?></span>个</a>） (<?php echo ($page); ?>) </h4>
...
<li class="current tabli" id="tab2"><a href="<?php echo U('Dining/orders',array('token'=>$token,'dining'=>1));?>">订单管理</a></li>
...
<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Dining/deleteOrder',array('token'=>$token,'id'=>$o['id'],'dining'=>$isDining));?>');">删除</a></td>
...
function showIntroDetail(id){
	art.dialog.open("<?php echo U('Dining/orderInfo',array('token'=>$token,'dining'=>$isDining));?>&id="+id,{lock:false,title:'订单详情',width:700,height:420,yesText:'关闭',background: '#000',opacity: 1});
}
</script>
</div>
<div class="cLine">
