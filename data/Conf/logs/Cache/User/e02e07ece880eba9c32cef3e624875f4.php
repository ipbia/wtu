...
<li class="current tabli" id="tab0"><a href="<?php echo U('Dining/index',array('token'=>$token,'dining'=>1));?>">菜品管理</a></li>
...
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Dining/add',array('token'=>$token,'dining'=>$isDining));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加<?php if($isDining != 1): ?>商品<?php else: ?>菜品<?php endif; ?></a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><div class="cateimg"><?php if($hostlist['logourl']): ?><img src="<?php echo ($hostlist["logourl"]); ?>" class="cateimg_big2"><img src="<?php echo ($hostlist["logourl"]); ?>" width="48" style="vertical-align:middle;"/><?php endif; ?> <?php echo ($hostlist["name"]); ?></div></td>
<td><?php echo ($hostlist["price"]); ?>元</td>
<td><a href="<?php echo U('index',array('catid'=>$hostlist['catid'],'token'=>$token,'dining'=>$isDining));?>"><?php echo ($hostlist["catname"]); ?></a></td>
<td><?php echo ($hostlist["keyword"]); ?></td>
<td><?php echo (date("Y-m-d H:i:s",$hostlist["time"])); ?></td> 

<td class="norightborder"><a href="<?php echo U('Dining/set',array('id'=>$hostlist['id'],'token'=>$token,'dining'=>$isDining));?>">修改</a> <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Dining/del',array('id'=>$hostlist['id'],'token'=>$token,'dining'=>$isDining));?>');">删除</a></td>
