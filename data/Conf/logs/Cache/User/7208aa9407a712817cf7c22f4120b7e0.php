...
<td class="norightborder"><a href="<?php echo U($type.'/infos',array('id'=>$item['id'],'token'=>$token));?>">订单管理</a>&nbsp;&nbsp;<a href="<?php echo U($type.'/setcin',array('id'=>$item['id'],'token'=>$token));?>">类型设置</a>&nbsp;&nbsp;<a href="<?php echo U($type.'/setinfo',array('id'=>$item['id'],'token'=>$token));?>">表单设置</a>&nbsp;&nbsp;<a href="<?php echo U($type.'/set',array('id'=>$item['id'],'token'=>$token));?>">修改</a>&nbsp;&nbsp;<a href="<?php echo U($type.'/del',array('id'=>$item['id'],'token'=>$token));?>">删除</a></td>
