...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
        ...
        <div class="content" style="width:920px; background:none; height:800px; border:none; margin-bottom:30px;" >
          ...
          <div class="cLine">
			...
			<a href='<?php echo U('Lottery/add',array('token'=>$token));?>' title='新增幸运大转盘活动' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-lottery.png" class="vm" />新增幸运大转盘活动</a>
