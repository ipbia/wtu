               ...
               <TR>
                ...
                <TR>
                 ...
                 <TR>
                  ...
                  <TD><input type="input" class="px" id="url" value="" name="url" style="width:580px;"> <a href="#" onclick="addLink('url',0)" class="a_choose">从功能库添加</a><br /><span class="red">如需跳转到其他网址，请在这里填写网址(例如：http://baidu.com，记住必须有http://)</span>如果填写了图文详细内容，这里请留空，不要设置！</TD>
                </TR>
				<TR>
