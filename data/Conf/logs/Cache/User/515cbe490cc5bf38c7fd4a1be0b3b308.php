...
<li class="tabli current" id="tab0"><a href="index.php?g=User&m=Xitie&a=zhufu&token=<?php echo ($token); ?>&id=<?php echo ($uid); ?>&type=2">收到的祝福</a></li>
<li class="tabli" id="tab0"><a href="index.php?g=User&m=Xitie&a=fuyan&token=<?php echo ($token); ?>&id=<?php echo ($uid); ?>&type=1">收到的赴宴信息</a></li>
</ul>
</div>
<!--tab end-->
