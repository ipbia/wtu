...
.Tab{ border-collapse:collapse; width:580px; height:90px;}
.Tab td{ border:solid 1px #fff}
</style>
<div class="content"  >
<div class="cLineB">
...
<table cellspacing="0" class="Tab" bgcolor="#FFFFFF">
          <tr height="20">
            <td width="20%" align="center"><a href="index.php?g=User&m=Member_card&a=design&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">设计修改</a></td>
            <td width="20%" align="center"><a href="index.php?g=User&m=Member_card&a=create&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">在线开卡</a></td>
            <td width="20%" align="center"><a href="index.php?g=User&m=Member_card&a=exchange&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">积分设置</a></td>
            <td width="20%" align="center"><a href="index.php?g=User&m=Member_card&a=notice&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">通知管理</a></td>
            <td width="20%" align="center"><a href="index.php?g=User&m=Member_card&a=privilege&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">特权管理</a></td>
          </tr>
          <tr height="20">
            <td width="20%" align="center"><a href="index.php?g=User&m=Member_card&a=coupon&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">优惠券管理</a></td>
            <td width="20%" align="center"><a href="index.php?g=User&m=Member_card&a=integral&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">礼品券管理</a></td>
            <td width="20%" align="center"><a href="index.php?g=User&m=Member_card&a=members&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">会员管理</a></td>
            <td width="20%" align="center"><a href="index.php?g=User&m=Member_card&a=staff&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">店员管理</a></td>
            <td width="20%" align="center"><a href="javascript:drop_confirm('您确定要删除吗?', 'index.php?g=User&m=Member_card&a=delete&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>');">删除该卡</a></td>
          </tr>
        </table></TD>
