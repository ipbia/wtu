...
<title>微信公众平台源码,微信机器人源码,微信自动回复源码 weiwin多用户微信营销系统</title>
...
<script type="text/javascript" src="<?php echo STATICS;?>/audioplayer/inc/jquery.jplayer.min.js"></script>

    <script type="text/javascript" src="<?php echo STATICS;?>/audioplayer/inc/jquery.mb.miniPlayer.js"></script>

    <link rel="stylesheet" type="text/css" href="<?php echo STATICS;?>/audioplayer/css/miniplayer.css" title="style" media="screen"/>
