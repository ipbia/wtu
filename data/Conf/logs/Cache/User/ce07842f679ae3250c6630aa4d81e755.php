...
<div class="cLineB">
  ...
  <h4>首页回复配置</h4>
    ...
    <h4>微网站url：<?php echo U('Wap/Index/index',array('token'=>$_GET['token']), true, false, true);?></h4>
			...
			<tbody>
				...
				<tr>
					...
					<th>回复图片：</th>
										...
										<td><input type="text" name="picurl" id="picurl" value="<?php echo ($home["picurl"]); ?>" class="px" style="width:550px;">   <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('picurl',700,420,'{pigcms:$token}')" class="a_upload">上传</a> <a href="###" onclick="viewImg('picurl')">预览</a></td>
					...
					<td><input type="text" name="homeurl" id="homeurl" value="<?php echo ($home["homeurl"]); ?>" class="px" style="width:550px;">  <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="chooseFile('homeurl','background')" class="a_upload">选择</a> <a href="###" onclick="upyunPicUpload('homeurl',1500,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('homeurl')">预览</a><br/> 只适用于引用第三方3G网站的链接</td>
					...
					<td><input type="text" name="musicurl" id="musicurl" value="<?php echo ($home["musicurl"]); ?>" class="px" style="width:550px;"><a href="###" onclick="chooseFile('musicurl','music')" class="a_upload">选择</a><br/> 如果填写网站会出现播放器，如果不填写则不出现</td>
