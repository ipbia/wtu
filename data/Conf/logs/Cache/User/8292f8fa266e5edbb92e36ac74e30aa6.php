            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><div class="cateimg"><img <?php if(empty($vo['pic'])): ?>src="<?php echo RES;?>/images/pic.png"<?php else: ?>src="<?php echo ($vo["pic"]); ?>"<?php endif; ?> class="cateimg_small" title="图文自定义内容" <?php if($vo['pic']): ?>style="width:150px;height:90px"<?php endif; ?>><?php echo ($vo["text"]); ?></div></td>
                  ...
                  <td><?php echo ($vo["click"]); ?></td>
				   ...
				   <a target="ddd"  href="<?php echo U('Wap/Index/content',array('token'=>$_SESSION['token'],'id'=>$vo['id']));?>" title="查看">查看</a>
