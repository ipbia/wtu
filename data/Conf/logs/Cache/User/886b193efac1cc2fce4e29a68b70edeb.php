...
<link rel="stylesheet" type="text/css" href="./tpl/User/default/common/weimeng-js/css/bootstrap_min.css" media="all" />

<link rel="stylesheet" type="text/css" href="./tpl/User/default/common/weimeng-js/css/style.css" media="all" />

<link rel="stylesheet" type="text/css" href="./tpl/User/default/common/weimeng-js/css/resource.css" media="all" />
<script type="text/javascript" src="./tpl/User/default/common/weimeng-js/jQuery.js"></script>
<script type="text/javascript" src="./tpl/User/default/common/weimeng-js/bootstrap_min.js"></script>
<script type="text/javascript" src="./tpl/User/default/common/weimeng-js/jquery_form_min.js"></script>
<script type="text/javascript" src="./tpl/User/default/common/weimeng-js/jquery_validate_min.js"></script>
<script type="text/javascript" src="./tpl/User/default/common/weimeng-js//jquery_validate_methods.js"></script>
<script type="text/javascript" src="./tpl/User/default/common/weimeng-js/resource.js"></script>
<script type="text/javascript" src="./tpl/User/default/common/weimeng-js/inside.js"></script>
...
<TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
  ...
  <TD><select name="fid"><option value="">根分类</option>

  <?php if(is_array($fidlist)): $i = 0; $__LIST__ = $fidlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
...
<TR>
  ...
  <TD><input type="input" class="px" id="img" value="" name="img" id="img" style="width:500px" >  <script src="<?php echo STATICS;?>/upyun.js?2013"></script><a href="###" onclick="chooseFile('img','icon')" class="a_upload">选择</a> <a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img')">预览</a></TD>
...
<TR>
  ...
  <TH valign="top"><label for="keyword">网站图标选择 ：</label></TH>

                                     <TD>   <div class="i-cont tile-themed">

                                                                                        <i class="<?php echo ($info["icon"]); ?>" id="icon_i"></i>

                                            <input type="hidden" id="icon" name="icon" value="<?php echo ($info["icon"]); ?>" />

                                            <a class="sel-icon" href="javascript:void(0);">选一个</a>
                                    ...
                                    </div>该图标用于二级页面右上角的缩略菜单和部分模板的首页主菜单</TD>
...
<TR>
  ...
  <TH valign="top"><label for="keyword">按钮背景颜色选择 ：</label></TH>

  <TD><input type="text" name="yanse" id="themeStyle" value="" class="px color" style="width: 55px; background-image: none; background-color:<?php echo ($homeInfo["plugmenucolor"]); ?>; color: rgb(255, 255, 255);" onblur="document.getElementById('plugmenucolor').style.backgroundColor=document.getElementById('themeStyle').value;">可以不选</TD>
