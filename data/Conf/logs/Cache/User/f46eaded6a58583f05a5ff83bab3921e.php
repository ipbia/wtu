...
<?php if(($parentid != '0') and ($parentid != '')): ?><a href="<?php echo U('Dining/cats',array('token'=>$token,'parentid'=>$parentCat['parentid']));?>" class="btnGreen" style="margin-top:-27px">返回上</a><?php endif; ?>
</form>
</div>
<div class="clr"></div>
</div>
...
<div class="tab">
<ul>
<?php if($set["catid"] != ''): ?><li class="current tabli" id="tab0"><a href="<?php echo U('Dining/ComIndex',array('token'=>$token));?>">更新信息</a></li><?php endif; ?> 
...
<li class="tabli" id="tab2"><a href="<?php echo U('Dining/cats',array('token'=>$token,'dining'=>1));?>">菜品分类管理</a></li>
<li class="tabli" id="tab2"><a href="<?php echo U('Dining/orders',array('token'=>$token,'dining'=>1));?>">订单管理</a></li>
<li class="tabli" id="tab2"><a href="<?php echo U('Dining/tables',array('token'=>$token,'dining'=>1));?>">桌台管理</a></li>
...
<?php if($set["catid"] != ''): ?><input type="hidden" name="id" value="<?php echo ($set["id"]); ?>" /><?php endif; ?>
      ...
      <tbody> 
       <tr> 
        ...
        <td>  <select name="catid" class="px require" style="width:400px;" >
         <?php if(is_array($Company)): $i = 0; $__LIST__ = $Company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($t["id"]); ?>"><?php echo ($t["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select> </td> 
       </tr>
       <tr> 
        <th><span class="red"></span>店铺公告：</th> 
        <td><input type="text" id="bulletin" name="bulletin" value="<?php echo ($set["bulletin"]); ?>" placeholder="如：店铺最新优惠：买10元送1元 " class="px require" style="width:400px;" /></td> 
       </tr> 
       <tr> 
        <th><span class="red"></span>店铺状态：</th> 
        <td>
        <select name="status" class="px require" style="width:400px;" >
        <option value="0" <?php if($set["status"] == 0): ?>selected<?php endif; ?>>营业中</option>
        <option value="1" <?php if($set["status"] == 1): ?>selected<?php endif; ?>>未营业</option></select> 
        </td> 
       </tr> 
        <tr> 
        <th><span class="red"></span>店铺类型：</th> 
        <td><input type="text" id="category" name="category" value="<?php echo ($set["category"]); ?>" placeholder="如：小吃、快餐 " class="px require" style="width:400px;" /></td> 
       </tr> 
       <tr> 
        <th><span class="red"></span>营业时间：</th> 
        <td><input type="text" id="time" name="time" value="<?php echo ($set["time"]); ?>" placeholder="如：8：00~22：00 " class="px require" style="width:400px;" /></td> 
       </tr> 
       <tr> 
        <th><span class="red"></span>起送价格：</th> 
        <td><input type="text" id="money" name="money" value="<?php echo ($set["money"]); ?>" placeholder="请填写数字，如50，仅保留小数点后2位 " class="px require" style="width:400px;" /></td> 
       </tr> 
       <tr> 
        <th><span class="red"></span>服务半径：</th> 
        <td><input type="text" id="radius" name="radius" value="<?php echo ($set["radius"]); ?>" placeholder="如：3公里   "  class="px require" style="width:400px;" /></td> 
       </tr> 
       <tr> 
        <th><span class="red"></span>配送区域：</th> 
        <td><input type="text" id="scope" name="scope" value="<?php echo ($set["scope"]); ?>" placeholder="如：置地大道等   "   class="px require" style="width:400px;" /></td> 
       </tr> 
       <tr>         
       <th>&nbsp;</th>
       <td>
